...
class TRAD_WOO_Product_Breadcrumb extends Widget_Base {
    ...
    public function get_title() {
        return __('WOO Product Breadcrumb', 'freemius-turbo-addons-elementor-pro');
    }
    ...
    protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Text Before Breadcrumb', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->start_controls_section(
            ...
            [
				'label' => esc_html__( 'Breadcrumb', 'freemius-turbo-addons-elementor-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE
            ]
		);
        ...
        $this->add_control(
            ...
            [
                'label' => __('Separator Type','freemius-turbo-addons-elementor-pro'),
                'type' => Controls_Manager::SELECT,
                'default' => 'text',
                'options' => [
                    'icon' => __('Icon','freemius-turbo-addons-elementor-pro'),
                    'text' => __('Default','freemius-turbo-addons-elementor-pro'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Separator Icon','freemius-turbo-addons-elementor-pro'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Separator Text','freemius-turbo-addons-elementor-pro'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Vertical Align','freemius-turbo-addons-elementor-pro'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
        ...
        $this->add_group_control(
            ...
            [
				...
				'label'    => __( 'Normal Typography', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Normal Color', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_group_control(
            ...
            [
				...
				'label'    => __( 'Active Typography', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Active Color', 'freemius-turbo-addons-elementor-pro' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#2E3195',
                'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Separator', 'freemius-turbo-addons-elementor-pro' ),
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                ...
                'label'    => esc_html__('Separator Typography','freemius-turbo-addons-elementor-pro'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Separator Color','freemius-turbo-addons-elementor-pro'),
                'type' => Controls_Manager::COLOR,
                'default' => '#2E3195',
                'selectors' => [
