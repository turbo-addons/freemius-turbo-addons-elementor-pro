...
class Trad_Whatsapp_Widget extends Widget_Base {
    ...
    public function get_title() { return esc_html__('WhatsApp', 'freemius-turbo-addons-elementor-pro'); }
    ...
    protected function get_upsale_data() {
        return [
            ...
            'description'  => esc_html__( 'Get the WhatsApp widget with Turbo Addons Elementor Pro.', 'freemius-turbo-addons-elementor-pro' ),
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('section_widget_mode', [
            'label' => __( 'Widget Mode', 'freemius-turbo-addons-elementor-pro' ),
        ]);
        $this->add_control('widget_mode', [
            'label'   => __( 'Mode', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::SELECT,
            'default' => 'inline_chat',
            'options' => [
                'inline_chat'   => __( 'Inline Chat Window', 'freemius-turbo-addons-elementor-pro' ),
                'floating_multi' => __( 'Floating Multi-Agent', 'freemius-turbo-addons-elementor-pro' ),
            ],
        ]);
        ...
        $this->start_controls_section('section_inline_agent', [
            'label'     => __( 'Agent Info', 'freemius-turbo-addons-elementor-pro' ),
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        $this->add_control('ic_agent_name', [
            'label'   => __( 'Agent Name', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXT,
            'default' => 'Rober Doe',
        ]);
        $this->add_control('ic_agent_tagline', [
            'label'   => __( 'Tagline / Status', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXT,
            'default' => 'Typically replies in a few hours',
        ]);
        $this->add_control('ic_agent_phone', [
            'label'       => __( 'WhatsApp Number', 'freemius-turbo-addons-elementor-pro' ),
            'type'        => Controls_Manager::TEXT,
            'description' => __( 'Include country code, e.g. +8801712345678', 'freemius-turbo-addons-elementor-pro' ),
            'placeholder' => '+8801712345678',
        ]);
        $this->add_control('ic_agent_avatar', [
            'label' => __( 'Agent Avatar', 'freemius-turbo-addons-elementor-pro' ),
            'type'  => Controls_Manager::MEDIA,
        ]);
        $this->add_control('ic_default_msg', [
            'label'   => __( 'Chat Bubble Message', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXTAREA,
            'default' => "Looking for the best offer? \nI'm happy to tell you",
            'rows'    => 3,
        ]);
        $this->add_control('ic_reply_placeholder', [
            'label'   => __( 'Reply Placeholder', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control('ic_button_style', [
            'label'   => __( 'Button Style', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::SELECT,
            'default' => 'avatar_name_sub',
            'options' => [
                'avatar_name_sub' => __( 'Avatar + Name + Subtitle', 'freemius-turbo-addons-elementor-pro' ),
                'avatar_name'     => __( 'Avatar + Name', 'freemius-turbo-addons-elementor-pro' ),
                'icon_text'       => __( 'Icon + Text', 'freemius-turbo-addons-elementor-pro' ),
            ],
        ]);
        ...
        $this->add_control('ic_btn_avatar', [
            'label'       => __( 'Button Avatar Image', 'freemius-turbo-addons-elementor-pro' ),
            'type'        => Controls_Manager::MEDIA,
            'description' => __( 'Upload a separate avatar for the button. If empty, uses Agent Avatar.', 'freemius-turbo-addons-elementor-pro' ),
            'condition'   => [ 'ic_button_style' => [ 'avatar_name_sub', 'avatar_name' ] ],
        ]);
        $this->add_control('ic_btn_icon', [
            'label'     => __( 'Button Icon', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::ICONS,
            'default'   => [ 'value' => 'fab fa-whatsapp', 'library' => 'fa-brands' ],
            'condition' => [ 'ic_button_style' => 'icon_text' ],
        ]);
        $this->add_control('ic_theme_color', [
            'label'   => __( 'Theme Color', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_control('button_layout', [
            'label'   => __( 'Position', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::SELECT,
            'default' => 'fixed-right',
            'options' => [
                'fixed-right' => __( 'Bottom Right (Floating)', 'freemius-turbo-addons-elementor-pro' ),
                'fixed-left'  => __( 'Bottom Left (Floating)', 'freemius-turbo-addons-elementor-pro' ),
            ],
        ]);
        $this->add_control('button_text', [
            'label'   => __( 'Button Text', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXT,
            'default' => __( 'Chat with us', 'freemius-turbo-addons-elementor-pro' ),
        ]);
        ...
        $this->start_controls_section('section_popup_header', [
            'label'     => __( 'Popup Header', 'freemius-turbo-addons-elementor-pro' ),
            'condition' => [ 'widget_mode' => 'floating_multi' ],
        ]);
        $this->add_control('header_title', [
            'label'   => __( 'Header Title', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXT,
            'default' => 'Start a Conversation',
        ]);
        $this->add_control('header_subtitle', [
            'label'   => __( 'Header Subtitle', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::TEXT,
        ...
        $this->start_controls_section('section_agents', [
            'label'     => __( 'Agents', 'freemius-turbo-addons-elementor-pro' ),
            'condition' => [ 'widget_mode' => 'floating_multi' ],
        ]);
        $repeater = new Repeater();
        $repeater->add_control('agent_name',    [ 'label' => __('Name', 'freemius-turbo-addons-elementor-pro'),    'type' => Controls_Manager::TEXT,    'default' => 'John Doe' ]);
        $repeater->add_control('agent_tagline', [ 'label' => __('Tagline', 'freemius-turbo-addons-elementor-pro'), 'type' => Controls_Manager::TEXT,    'default' => 'Typically replies in a few hours' ]);
        $repeater->add_control('agent_phone',   [ 'label' => __('WhatsApp Number', 'freemius-turbo-addons-elementor-pro'), 'type' => Controls_Manager::TEXT, 'description' => 'e.g. +8801712345678' ]);
        $repeater->add_control('agent_avatar',  [ 'label' => __('Avatar', 'freemius-turbo-addons-elementor-pro'),  'type' => Controls_Manager::MEDIA ]);
        $repeater->add_control('default_msg',   [ 'label' => __('Default Message', 'freemius-turbo-addons-elementor-pro'), 'type' => Controls_Manager::TEXTAREA, 'default' => 'Hi there! How can I help you?' ]);
        $this->add_control('agents', [
            'label'       => __( 'Agent List', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_responsive_control('floating_btn_align', [
            'label'   => __( 'Button Alignment', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => [
                'flex-start' => [ 'title' => __('Left',   'freemius-turbo-addons-elementor-pro'), 'icon' => 'eicon-text-align-left'   ],
                'center'     => [ 'title' => __('Center', 'freemius-turbo-addons-elementor-pro'), 'icon' => 'eicon-text-align-center' ],
                'flex-end'   => [ 'title' => __('Right',  'freemius-turbo-addons-elementor-pro'), 'icon' => 'eicon-text-align-right'  ],
            ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __( 'Text Typography', 'freemius-turbo-addons-elementor-pro' ),
                'selector' => '{{WRAPPER}} .trad-whatsapp-button .trad-whatsapp-text',
            ]
        );
        $this->add_responsive_control('button_icon_gap', [
            'label'      => __( 'Icon & Text Gap', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
        ...
        $this->start_controls_tabs('button_color_tabs');
            ...
            $this->add_control('button_hover_transition', [
                'label'     => __( 'Transition Duration (s)', 'freemius-turbo-addons-elementor-pro' ),
                'type'      => Controls_Manager::SLIDER,
        ...
        $this->start_controls_section('style_body', [
            'label'     => __( 'Body & Agents', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'floating_multi' ],
        ]);
        $this->add_control('body_bg', [
            'label'     => __( 'Body Background', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .trad-whatsapp-body' => 'background-color: {{VALUE}}' ],
        ]);
        $this->add_control('agent_bg', [
            'label'     => __( 'Agent Card Background', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .trad-whatsapp-agent' => 'background-color: {{VALUE}}' ],
        ]);
        $this->add_control('agent_name_color', [
            'label'     => __( 'Agent Name Color', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .trad-whatsapp-agent-name' => 'color: {{VALUE}}' ],
        ]);
        $this->add_control('agent_tagline_color', [
            'label'     => __( 'Agent Tagline Color', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
        ...
        $this->add_responsive_control('agent_avatar_size', [
            'label'      => __( 'Agent Avatar Size', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
        ...
        $this->add_responsive_control('agent_avatar_border_radius', [
            'label'      => __( 'Agent Avatar Border Radius', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', '%' ],
        ...
        $this->add_control('agent_avatar_border_color', [
            'label'     => __( 'Agent Avatar Border Color', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .trad-whatsapp-agent-avatar' => 'border-color: {{VALUE}};' ],
        ]);
        $this->add_responsive_control('agent_avatar_border_width', [
            'label'      => __( 'Agent Avatar Border Width', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
        ...
        $this->start_controls_section('style_ic_header', [
            'label'     => __( 'Chat Header', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        $this->add_control('ic_header_bg', [
            'label'     => __( 'Header Background', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [ 'name' => 'ic_header_name_typo', 'label' => __('Name Typography', 'freemius-turbo-addons-elementor-pro'), 'selector' => '{{WRAPPER}} .trad-wa-cw-hname' ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [ 'name' => 'ic_header_status_typo', 'label' => __('Status Typography', 'freemius-turbo-addons-elementor-pro'), 'selector' => '{{WRAPPER}} .trad-wa-cw-hstatus' ]
        );
        ...
        $this->add_responsive_control('ic_avatar_size', [
            'label'      => __( 'Avatar Size', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
            'range'      => [ 'px' => [ 'min' => 20, 'max' => 100 ] ],
            'selectors'  => [
        ...
        $this->add_responsive_control('ic_avatar_border_radius', [
            'label'      => __( 'Avatar Border Radius', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', '%' ],
            'default'    => [ 'top' => '50', 'right' => '50', 'bottom' => '50', 'left' => '50', 'unit' => '%' ],
        ...
        $this->add_control('ic_avatar_border_color', [
            'label'     => __( 'Avatar Border Color', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => 'rgba(255,255,255,0.5)',
            'selectors' => [ '{{WRAPPER}} .trad-wa-cw-avatar' => 'border-color: {{VALUE}};' ],
        ]);
        $this->add_responsive_control('ic_avatar_border_width', [
            'label'      => __( 'Avatar Border Width', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
            'range'      => [ 'px' => [ 'min' => 0, 'max' => 10 ] ],
        ...
        $this->start_controls_section('style_ic_card', [
            'label'     => __( 'Chat Card (Popup)', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        $this->add_responsive_control('ic_card_width', [
            'label'      => __( 'Card Width', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%', 'vw' ],
        ...
        $this->add_responsive_control('ic_card_margin', [
            'label'      => __( 'Card Margin', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
        ...
        $this->start_controls_section('style_ic_body', [
            'label'     => __( 'Chat Body Area', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        ...
        $this->add_responsive_control('ic_body_min_height', [
            'label'      => __( 'Min Height', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px', 'vh' ],
        ...
        $this->add_responsive_control('ic_body_max_height', [
            'label'      => __( 'Max Height', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px', 'vh' ],
        ...
        $this->start_controls_section('style_ic_bubble', [
            'label'     => __( 'Chat Bubble', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        $this->add_responsive_control('ic_bubble_align', [
            'label'   => __( 'Bubble Alignment', 'freemius-turbo-addons-elementor-pro' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => [
                'left'   => [ 'title' => __('Left',   'freemius-turbo-addons-elementor-pro'), 'icon' => 'eicon-text-align-left'   ],
                'center' => [ 'title' => __('Center', 'freemius-turbo-addons-elementor-pro'), 'icon' => 'eicon-text-align-center' ],
                'right'  => [ 'title' => __('Right',  'freemius-turbo-addons-elementor-pro'), 'icon' => 'eicon-text-align-right'  ],
            ],
            'default'   => 'left',
            'selectors' => [ '{{WRAPPER}} .trad-wa-cw-body' => 'text-align: {{VALUE}};' ],
        ]);
        $this->add_control('ic_bubble_bg', [
            'label'     => __( 'Bubble Background', 'freemius-turbo-addons-elementor-pro' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#ffffff',
            'selectors' => [ '{{WRAPPER}} .trad-wa-cw-bubble' => 'background-color: {{VALUE}}' ],
        ]);
        $this->add_responsive_control('ic_bubble_padding', [
            'label'      => __( 'Bubble Padding', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
        ...
        $this->add_responsive_control('ic_bubble_margin', [
            'label'      => __( 'Bubble Margin', 'freemius-turbo-addons-elementor-pro' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
        ...
        $this->start_controls_section('style_ic_sender', [
            'label'     => __( 'Sender Name', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        ...
        $this->start_controls_section('style_ic_message', [
            'label'     => __( 'Message Text', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        ...
        $this->start_controls_section('style_ic_time', [
            'label'     => __( 'Timestamp', 'freemius-turbo-addons-elementor-pro' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [ 'widget_mode' => 'inline_chat' ],
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __( 'Name Typography', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __( 'Subtitle Typography', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __( 'Button Text Typography', 'freemius-turbo-addons-elementor-pro' ),
        ...
        $this->start_controls_tabs('ic_btn_color_tabs');
            ...
            $this->add_control('ic_btn_label_color', [
                'label'     => __( 'Button Text Color', 'freemius-turbo-addons-elementor-pro' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
    ...
    private function render_inline_chat( $settings ) {
        ...
        <div class="trad-wa-inline-wrapper">
            ...
            <div class="trad-wa-chatwin">
                ...
                <div class="trad-wa-cw-header" style="background-color:<?php echo esc_attr( $color ); ?>">
                    <?php if ( $avatar_url ): ?>
                        <img class="trad-wa-cw-avatar" src="<?php echo esc_url( $avatar_url ); ?>" alt="<?php echo esc_attr( $name ); ?>">
                    <?php else: ?>
                    ...
                    <div class="trad-wa-cw-header-info">
                        <span class="trad-wa-cw-hname"><?php echo esc_html( $name ); ?></span>
                ...
                <div class="trad-wa-cw-body">
                    <div class="trad-wa-cw-bubble">
                        <div class="trad-wa-cw-sender"><?php echo esc_html( $name ); ?></div>
                        <div class="trad-wa-cw-msg"><?php echo wp_kses_post( $msg ); ?></div>
                        <div class="trad-wa-cw-time"><?php echo esc_html( $time ); ?></div>
                    </div>
                </div>

                <a href="<?php echo esc_url( $wa_link ); ?>" target="<?php echo ( $wa_link !== '#' ) ? '_blank' : '_self'; ?>" rel="noopener noreferrer" class="trad-wa-cw-footer">
                    <span class="trad-wa-cw-placeholder"><?php echo esc_html( $placeholder ); ?></span>
                    <span class="trad-wa-cw-send-btn" style="background-color:<?php echo esc_attr( $color ); ?>">
            ...
            <?php if ($btn_style === 'avatar_name_sub'): ?>
                <div class="trad-wa-cw-btn trad-wa-btn-avatar-sub" style="background-color:<?php echo esc_attr( $color ); ?>">
                    <?php if ($btn_avatar_url): ?>
                        <img src="<?php echo esc_url( $btn_avatar_url ); ?>" alt="<?php echo esc_attr( $name ); ?>" class="trad-wa-btn-avatar">
                    <?php endif; ?>
                    <div class="trad-wa-btn-info">
                        <span class="trad-wa-btn-name"><?php echo esc_html( $name ); ?></span>
                        <span class="trad-wa-btn-sub"><?php echo esc_html( $tagline ); ?></span>
                    </div>
                </div>

            <?php elseif ($btn_style === 'avatar_name'): ?>
                <div class="trad-wa-cw-btn trad-wa-btn-avatar-name" style="background-color:<?php echo esc_attr( $color ); ?>">
                    <?php if ($btn_avatar_url): ?>
                        <img src="<?php echo esc_url( $btn_avatar_url ); ?>" alt="<?php echo esc_attr( $name ); ?>" class="trad-wa-btn-avatar">
                    <?php endif; ?>
                    <span class="trad-wa-btn-name"><?php echo esc_html( $name ); ?></span>
            ...
            <?php else: // icon_text ?>
                <div class="trad-wa-cw-btn trad-wa-btn-icon-text" style="background-color:<?php echo esc_attr( $color ); ?>">
                    ...
                    <span class="trad-wa-btn-name"><?php echo esc_html( $btn_text ); ?></span>
                </div>
            <?php endif; ?>
